...
public class studentLogin2 extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        headTitle.setText("Student Login");
        ...
        icon2 = new ImageIcon("abc.png");// pic->ImageIcon->JLabel
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(login)) {
            ...
            studentDataSeparator mds = new studentDataSeparator();
            mds.dataSeparate(i);
            if (b) {
                dispose();
                String path = "member.txt";
                studentPanel frame = new studentPanel(path);
